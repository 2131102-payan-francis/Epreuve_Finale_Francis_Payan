...
return [
    ...
    // Ajoutez la dépendance UserRepository dans le container de dépendances de l'application Slim
    /* UserRepository::class => function (ContainerInterface $container) {
        return new UserRepository($container->get(PDO::class));
    }, */

    // Ajoutez la dépendance UserController dans le container de dépendances de l'application Slim
